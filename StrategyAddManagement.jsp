                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post" action="manage?tableName=Strategy&tableOperation=add">
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">博客标题</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="sTitle" class="form-control" placeholder="请输入新的博客标题">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="sText" class="form-control" placeholder="请输入新的博客内容">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="sDataTime" class="form-control date" data-toggle="date-picker" data-single-date-picker="true">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="sPlace" class="form-control" placeholder="请输入新的博客发布地点">
                                                </div>
                                            </div>
                                           ...
                                           <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="sReading" class="form-control" placeholder="请输入新的博客阅读量">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select name="bNumber" class="wide" data-plugin="customselect">
                                                        <option selected="">请选择用户账号</option>
