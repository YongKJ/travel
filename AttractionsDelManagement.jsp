                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">删除景点</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">删除景点</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                                ...
                                                <tbody>
                                                    <c:forEach var="attractions" items="${attractionsList}">
                                                        <tr>
                                                            ...
                                                            <td><a href="manage?tableName=Attractions&tableOperation=del&id=<c:out value="${attractions.getaId()}"/>">删除</a></td>
                                                        </tr>
                                                    </c:forEach>
<!--                                                     <tr>
                                                        <th scope="row">1</th>
