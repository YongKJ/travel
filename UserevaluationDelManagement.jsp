                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">删除评论</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">删除评论</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive"> 
                                            ...
                                            <table class="table mb-0 text-center" style="width:1174px;">
                                                ...
                                                <tbody>
                                                    <c:forEach var="userevaluation" items="${userevaluationsList}">
                                                        <tr>
                                                            <th scope="row"><c:out value="${userevaluation.getuId()}"/></th>
                                                            <td><c:out value="${userevaluation.getuEvaluationText()}"/></td>
                                                            <td><c:out value="${userevaluation.getuPicture()}"/></td>
                                                            <td><c:out value="${userevaluation.getuData()}"/></td>
                                                            <td><c:out value="${attractionsMap.get(userevaluation.getuAttractionsId()).getaName()}"/></td>
                                                            <td><c:out value="${busertablesMap.get(userevaluation.getuBUserTableId()).getbNumber()}"/></td>
                                                            <td><a href="manage?tableName=Userevaluation&tableOperation=del&id=<c:out value="${userevaluation.getuId()}"/>">删除</a></td>
                                                        </tr>
                                                    </c:forEach>
<!--                                                     <tr>
                                                        <th scope="row">1</th>
