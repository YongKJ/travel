                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">添加关注</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">添加关注</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post" action="manage?tableName=Attention&tableOperation=add">
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">关注时间</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="aData" class="form-control date" data-toggle="date-picker" data-single-date-picker="true">
                                                </div>
                                            </div>
