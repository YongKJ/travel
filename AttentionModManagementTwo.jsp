                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="#">关注管理</a></li>
                                            <li class="breadcrumb-item active">修改关注</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">修改关注</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post" action="manage?tableName=Attention&tableOperation=modTwo&id=<c:out value="${attention.getaId()}"/>">
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">关注时间</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="aData" class="form-control" data-toggle="input-mask" data-mask-format="0000-00-00 00:00:00.0" maxlength="21" value="<c:out value="${attention.getaData()}"/>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select name="aName" class="wide" data-plugin="customselect">
                                                        <option selected=""><c:out value="${attractionsMap.get(attention.getaAttractionsId()).getaName()}"/></option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select name="bNumber" class="wide" data-plugin="customselect">
                                                        <option selected=""><c:out value="${busertablesMap.get(attention.getaBUserTableId()).getbNumber()}"/></option>
