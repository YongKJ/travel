                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">添加景点</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">添加景点</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post" action="manage?tableName=Attractions&tableOperation=add">
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">景区名称</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="aName" class="form-control" placeholder="请输入新的景区名称">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="aPicture" class="form-control" placeholder="请输入新的景区图片文件名">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="aBstract" class="form-control" placeholder="请输入新的景区简介">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="aUnitPrice" class="form-control" placeholder="请输入新的景区单价">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="aCostContent" class="form-control" placeholder="请输入新的景区费用包含">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="aScore" class="form-control" placeholder="请输入新的景区点评分数">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="lName" class="form-control" placeholder="请输入新的景区标签">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select id="proName" name="proName" class="form-control" onchange="chooseProvince(this)">
                                                        <option selected="">请选择新景区的所处省份</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select id="cityName" name="cityName" class="form-control">
                                                        <option selected="">请选择新景区的所处城市</option>
                                                    </select>
                                                </div>
                                            </div>
