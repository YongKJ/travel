                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post" action="manage?tableName=Busertable&tableOperation=add">
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">账号</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="bNumber" class="form-control" placeholder="请输入新的账号">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="password" name="bPWD" class="form-control" placeholder="请输入新的密码">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="bName" class="form-control" placeholder="请输入新的昵称">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="email" name="bEmail" class="form-control" placeholder="请输入新的邮箱">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="rName" class="form-control" placeholder="请输入您的真实姓名">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control date" name="birthday" type="text" data-toggle="date-picker" data-single-date-picker="true">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="bPhone" class="form-control" placeholder="请输入新的手机号码">
                                                </div>
                                            </div>
