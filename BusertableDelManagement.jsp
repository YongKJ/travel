                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive"> 
                                            ...
                                            <table class="table mb-0 text-center" style="width:1174px;">
                                                ...
                                                <tbody>
                                                    <c:forEach var="busertable" items="${busertablesList}">
                                                        <tr>
                                                            <th scope="row"><c:out value="${busertable.getbId()}"/></th>
                                                            <td><c:out value="${busertable.getbNumber()}"/></td>
                                                            <td><c:out value="${busertable.getbPWD()}"/></td>
                                                            <td><c:out value="${busertable.getbName()}"/></td>
                                                            <td><c:out value="${busertable.getbEmail()}"/></td>
                                                            <td><c:out value="${busertable.getrName()}"/></td>
                                                            <td><c:out value="${busertable.getbSex()}"/></td>
                                                            <td><c:out value="${busertable.getBirthday()}"/></td>
                                                            <td><c:out value="${busertable.getbPhone()}"/></td>
                                                            <td><a href="manage?tableName=Busertable&tableOperation=del&id=<c:out value="${busertable.getbId()}"/>">删除</a></td>
                                                        </tr>
                                                    </c:forEach>
<!--                                                     <tr>
                                                        <th scope="row">1</th>
