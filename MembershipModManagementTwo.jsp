                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">修改团费</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">修改团费</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post" action="manage?tableName=Membership&tableOperation=modTwo&id=<c:out value="${membership.getmId()}"/>">
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">团费类型</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="mName" class="form-control" value="<c:out value="${membership.getmName()}"/>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="mPrice" class="form-control" value="<c:out value="${membership.getmPrice()}"/>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select name="aName" class="wide" data-plugin="customselect">
                                                        <option selected=""><c:out value="${attractionsMap.get(membership.getmAttractionsId()).getaName()}"/></option>
