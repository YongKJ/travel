                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive"> 
                                            ...
                                            <table class="table mb-0 text-center" style="width:1174px;">
                                                ...
                                                <tbody>
                                                    <c:forEach var="attractions" items="${attractionsList}">
                                                        <tr>
                                                            <th scope="row"><c:out value="${attractions.getaId()}"/></th>
                                                            <td><c:out value="${attractions.getaName()}"/></td>
                                                            <td><c:out value="${attractions.getaPicture()}"/></td>
                                                            <td><c:out value="${attractions.getaBstract()}"/></td>
                                                            <td><c:out value="${attractions.getaUnitPrice()}"/></td>
                                                            <td><c:out value="${attractions.getaCostContent()}"/></td>
                                                            <td><c:out value="${attractions.getaScore()}"/></td>
                                                            <td><c:out value="${labelsMap.get(attractions.getaLabelId()).getlName()}"/></td>
                                                            <td><c:out value="${citysMap.get(attractions.getaCityId()).getCityName()}"/></td>
                                                            <td><a href="manage?tableName=Attractions&tableOperation=modOne&id=<c:out value="${attractions.getaId()}"/>">修改</a></td>
                                                        </tr>
                                                    </c:forEach>
<!--                                                     <tr>
                                                        <th scope="row">1</th>
