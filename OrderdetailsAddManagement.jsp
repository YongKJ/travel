                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">添加订单</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">添加订单</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post" action="manage?tableName=Order&tableOperation=add">
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">订单金额</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="oPrice" class="form-control" placeholder="请输入新的订单金额">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="oState" class="form-control" placeholder="请输入新的订单状态">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="oData" class="form-control date" data-toggle="date-picker" data-single-date-picker="true">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="number" class="form-control" placeholder="请输入新的下单数量">
                                                </div>
                                            </div>
