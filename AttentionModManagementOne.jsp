                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive"> 
                                            ...
                                            <table class="table mb-0 text-center" style="width:1174px;">
                                                ...
                                                <tbody>
                                                    <c:forEach var="attention" items="${attentionsList}">
                                                        <tr>
                                                            <th scope="row"><c:out value="${attention.getaId()}"/></th>
                                                            <td><c:out value="${attention.getaData()}"/></td>
                                                            <td><c:out value="${attractionsMap.get(attention.getaAttractionsId()).getaName()}"/></td>
                                                            <td><c:out value="${busertablesMap.get(attention.getaBUserTableId()).getbNumber()}"/></td>
                                                            <td><a href="manage?tableName=Attention&tableOperation=modOne&id=<c:out value="${attention.getaId()}"/>">修改</a></td>
                                                        </tr>
                                                    </c:forEach>
<!--                                                     <tr>
                                                        <th scope="row">1</th>
