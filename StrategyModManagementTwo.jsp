                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">修改博客</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">修改博客</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post" action="manage?tableName=Strategy&tableOperation=modTwo&id=<c:out value="${strategy.getsId()}"/>">
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">博客标题</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="sTitle" class="form-control" value="<c:out value="${strategy.getsTitle()}"/>">
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">博客内容</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="sText" class="form-control" value="<c:out value="${strategy.getsText()}"/>">
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">博客发布时间</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="sDataTime" class="form-control" data-toggle="input-mask" data-mask-format="0000-00-00 00:00:00.0" maxlength="21" value="<c:out value="${strategy.getsDataTime()}"/>">
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">博客发布地点</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="sPlace" class="form-control" value="<c:out value="${strategy.getsPlace()}"/>">
                                                </div>
                                            </div>
                                            
                                           <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">博客阅读量</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="sReading" class="form-control" value="<c:out value="${strategy.getsReading()}"/>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select name="bNumber" class="wide" data-plugin="customselect">
                                                        <option selected=""><c:out value="${busertablesMap.get(strategy.getsBUserTableId()).getbNumber()}"/></option>
