                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">删除博客</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">删除博客</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                                ...
                                                <tbody>
                                                    <c:forEach var="strategy" items="${strategysList}">
                                                        <tr>
                                                            ...
                                                            <td><a href="manage?tableName=Strategy&tableOperation=del&id=<c:out value="${strategy.getsId()}"/>">删除</a></td>
                                                        </tr>
                                                    </c:forEach>
<!--                                                     <tr>
                                                        <th scope="row">1</th>
