  ...
  (e.prototype.initSelect2 = function() {
    ...
    (e.prototype.initMask = function() {
      t('[data-toggle="input-mask"]').each(function(e, n) {
        var o = t(n).data("maskFormat"),
          i = t(n).data("reverse");
        null != i ? t(n).mask(o, { reverse: i }) : t(n).mask(o);
      });
    }),
    (e.prototype.initDateRange = function() {
      var e = { cancelClass: "btn-light", applyButtonClasses: "btn-success" };
      t('[data-toggle="date-picker"]').each(function(n, o) {
      ...
      t('[data-toggle="date-picker-range"]').each(function(e, o) {
        var i = t.extend({}, n, t(o).data()),
          a = i.targetDisplay;
        t(o).daterangepicker(i, function(e, n) {
          a &&
            t(a).html(
              e.format("MMMM D, YYYY") + " - " + n.format("MMMM D, YYYY")
            );
        });
      });
    }),
  ...
  (function(t) {
    ...
    (e.prototype.initMenu = function() {
      ...
      t(".button-menu-mobile").on("click", function(n) {
        n.preventDefault(),
          e.$window.width() < 768 && e.$body.toggleClass("sidebar-enable"),
        ...
        t(document).on("click", "body", function(e) {
          t(e.target).closest(".right-bar-toggle, .right-bar").length > 0 ||
            t(e.target).closest(".left-side-menu, #sidebar-menu").length > 0 ||
            t(e.target).hasClass("button-menu-mobile") ||
            t(e.target).closest(".button-menu-mobile").length > 0 ||
            (t("body").removeClass("right-bar-enabled"),
            t("body").removeClass("sidebar-enable"));
        }),
        ...
        this.$window.on("resize", function(t) {
          t.preventDefault(), location.reload(!0);
        });
    }),
