...
{name:'香港特别行政区',areaList:[]}
]},
{name:'澳门特别行政区', cityList:[
{name:'澳门特别行政区',areaList:[]}
]}
];
var provinceArray = new Array();
var cityArray = new Array();
var areaArray = new Array();
var provinceTag = document.getElementById("proName");
var cityTag = document.getElementById("cityName");
...
// 	var index = th.selectedIndex-1;　　　　　　　　　　//此处selectedIndex的索引减1是因为我们在写<select><option>按钮时  “请选择省”  占了一个索引，所以需要减1才能对应
	var provinceName = document.getElementById("proName").value;　　　　//通过数组下标获取数据（名字）
    ...
    if(provinceName == null) {
        cityTag.innerHTML="";
        cityTag.add(new Option("请选择新景区的所处城市", 0));
    }
}
