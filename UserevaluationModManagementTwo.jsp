                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post" action="manage?tableName=Userevaluation&tableOperation=modTwo&id=<c:out value="${userevaluation.getuId()}"/>">
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">评价内容</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="uEvaluationText" class="form-control" value="<c:out value="${userevaluation.getuEvaluationText()}"/>">
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">图片文件名</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="uPicture" class="form-control" value="<c:out value="${userevaluation.getuPicture()}"/>">
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">发表日期</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="uData" class="form-control" data-toggle="input-mask" data-mask-format="0000-00-00 00:00:00.0" maxlength="21" value="<c:out value="${userevaluation.getuData()}"/>">
                                                </div>
                                            </div>
                                            
                                           <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">关注景点</label>
                                                <div class="col-sm-10">
                                                    <select name="aName" class="wide" data-plugin="customselect">
                                                        <option selected=""><c:out value="${attractionsMap.get(userevaluation.getuAttractionsId()).getaName()}"/></option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select name="bNumber" class="wide" data-plugin="customselect">
                                                        <option selected=""><c:out value="${busertablesMap.get(userevaluation.getuBUserTableId()).getbNumber()}"/></option>
