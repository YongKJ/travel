                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive"> 
                                            ...
                                            <table class="table mb-0 text-center" style="width:1174px;">
                                                ...
                                                <tbody>
                                                    <c:forEach var="strategy" items="${strategysList}">
                                                        <tr>
                                                            <th scope="row"><c:out value="${strategy.getsId()}"/></th>
                                                            <td><c:out value="${strategy.getsTitle()}"/></td>
                                                            <td><c:out value="${strategy.getsText()}"/></td>
                                                            <td><c:out value="${strategy.getsDataTime()}"/></td>
                                                            <td><c:out value="${strategy.getsPlace()}"/></td>
                                                            <td><c:out value="${strategy.getsReading()}"/></td>
                                                            <td><c:out value="${busertablesMap.get(strategy.getsBUserTableId()).getbNumber()}"/></td>
                                                            <td><a href="manage?tableName=Strategy&tableOperation=modOne&id=<c:out value="${strategy.getsId()}"/>">修改</a></td>
                                                        </tr>
                                                    </c:forEach>
<!--                                                     <tr>
                                                        <th scope="row">1</th>
