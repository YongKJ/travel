                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">删除订单</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">删除订单</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                            ...
                                            <table class="table mb-0 text-center" style="width:1174px;">
                                                ...
                                                <tbody>
                                                    <c:forEach var="orderdetails" items="${orderdetailsList}">
                                                        <tr>
                                                            <th scope="row"><c:out value="${orderdetails.getdOrderId()}"/></th>
                                                            <td><c:out value="${ordersMap.get(orderdetails.getdOrderId()).getoPrice()}"/></td>
                                                            <td><c:out value="${ordersMap.get(orderdetails.getdOrderId()).getoState()}"/></td>
                                                            <td><c:out value="${ordersMap.get(orderdetails.getdOrderId()).getoData()}"/></td>
                                                            <td><c:out value="${orderdetails.getNumber()}"/></td>
                                                            <td><c:out value="${attractionsMap.get(orderdetails.getdAttractionsId()).getaName()}"/></td>
                                                            <td><c:out value="${busertablesMap.get(ordersMap.get(orderdetails.getdOrderId()).getoBUserTableId()).getbNumber()}"/></td>
                                                            <td><a href="manage?tableName=Order&tableOperation=del&id=<c:out value="${orderdetails.getdOrderId()}"/>&aName=<c:out value="${attractionsMap.get(orderdetails.getdAttractionsId()).getaName()}"/>&number=<c:out value="${orderdetails.getNumber()}"/>">删除</a></td>
                                                        </tr>
                                                    </c:forEach>
<!--                                                     <tr>
                                                        <th scope="row">1</th>
