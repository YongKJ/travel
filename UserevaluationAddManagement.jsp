                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post" action="manage?tableName=Userevaluation&tableOperation=add">
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">评价内容</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="uEvaluationText" class="form-control" placeholder="请输入新的评价内容">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="uPicture" class="form-control" placeholder="请输入新的图片文件名">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="uData" class="form-control date" data-toggle="date-picker" data-single-date-picker="true">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select name="aName" class="wide" data-plugin="customselect">
                                                        <option selected="">请选择关注景点</option>
