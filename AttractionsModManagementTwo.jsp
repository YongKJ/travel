...
<!--                                     <span class="badge badge-danger rounded-circle noti-icon-badge">2</span> -->
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="#">景点管理</a></li>
                                            <li class="breadcrumb-item active">修改景点</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">修改景点</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post" action="manage?tableName=Attractions&tableOperation=modTwo&id=<c:out value="${attractions.getaId()}"/>">
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">景区名称</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="aName" class="form-control" value="<c:out value="${attractions.getaName()}"/>">
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">景区图片</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="aPicture" class="form-control" value="<c:out value="${attractions.getaPicture()}"/>">
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">景区简介</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="aBstract" class="form-control" value="<c:out value="${attractions.getaBstract()}"/>">
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label" for="example-email">单价</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="aUnitPrice" class="form-control" value="<c:out value="${attractions.getaUnitPrice()}"/>">
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">费用包含</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="aCostContent" class="form-control" value="<c:out value="${attractions.getaCostContent()}"/>">
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">点评分数</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="aScore" class="form-control" value="<c:out value="${attractions.getaScore()}"/>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="lName" class="form-control" value="<c:out value="${labelsMap.get(attractions.getaLabelId()).getlName()}"/>">
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">所处省份</label>
                                                <div class="col-sm-10">
                                                    <select id="proName" name="proName" class="form-control" onchange="chooseProvince(this)">
                                                        <option selected=""><c:out value="${promarysMap.get(citysMap.get(attractions.getaCityId()).getProId()).getProName()}"/></option>
                                                    </select>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">所处城市</label>
                                                <div class="col-sm-10">
                                                    <select id="cityName" name="cityName" class="form-control">
                                                        <option selected=""><c:out value="${citysMap.get(attractions.getaCityId()).getCityName()}"/></option>
                                                    </select>
                                                </div>
                                            </div>
        ...
        <script src="images/province.js"></script>
